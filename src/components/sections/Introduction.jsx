      ...
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-8">
            Are You Ready to <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Transform Your Path?</span>
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <SafeIcon icon={FiUsers} className="text-4xl text-blue-600 mx-auto mb-4" />
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <SafeIcon icon={FiTrendingUp} className="text-4xl text-purple-600 mx-auto mb-4" />
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Clear & Simple</h3>
