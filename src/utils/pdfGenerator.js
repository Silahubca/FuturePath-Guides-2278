...
export const generateAIJobSearchPDF = () => {
  const doc = new jsPDF()
  const bookData = BOOK_CONTENT['ai-job-search']
  ...
  doc.text('AI-POWERED JOB SEARCH', pageWidth / 2, 40, {align: 'center'})
  
  doc.setFontSize(18)
  doc.text('Your Blueprint for Success in 2025', pageWidth / 2, 55, {align: 'center'})
  
  doc.setFontSize(12)
  doc.setFont(undefined, 'normal')
  doc.text('Master the AI-driven job market and land your dream job faster', pageWidth / 2, 80, {align: 'center'})
...
export const generateAIEntrepreneurPDF = () => {
  const doc = new jsPDF()
  const bookData = BOOK_CONTENT['ai-entrepreneur']
  ...
  doc.setFontSize(24)
  doc.setFont(undefined, 'bold')
  doc.text('THE AI ENTREPRENEUR', pageWidth / 2, 40, {align: 'center'})
  
  doc.setFontSize(18)
  doc.text('Blueprint for a Lean Digital Business', pageWidth / 2, 55, {align: 'center'})
  
  doc.setFontSize(12)
  doc.setFont(undefined, 'normal')
  doc.text('Launch your lean digital business with AI-powered strategies', pageWidth / 2, 80, {align: 'center'})
...
export const downloadAIJobSearchPDF = () => {
  const pdf = generateAIJobSearchPDF()
  pdf.save('AI-Powered-Job-Search-Blueprint.pdf')
}

export const downloadAIEntrepreneurPDF = () => {
  const pdf = generateAIEntrepreneurPDF()
  pdf.save('AI-Entrepreneur-Blueprint.pdf')
}
